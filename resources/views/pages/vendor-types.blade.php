      ...
      var statuses = [
        ...
        var crudServiceBaseUrl = "{{url('')}}",
            dataSource = new kendo.data.DataSource({
                transport: {
                    read:  {
                        url: crudServiceBaseUrl + "/vendor-types/get",
                        type: "GET",
                        dataType: "json"
                    },
                    update: {
                        url: crudServiceBaseUrl + "/vendor-types/update",
                        type: "Post",
                        dataType: "json"
                    },
                    destroy: {
                        url: crudServiceBaseUrl + "/vendor-types/destroy",
                        type: "Post",
                        dataType: "json"
                    },
                    create: {
                        url: crudServiceBaseUrl + "/vendor-types/store",
                        type: "Post",
                        dataType: "json"
                    },
