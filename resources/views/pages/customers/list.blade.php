...
<script>
  ...
  $(document).ready(function () {
    ...
    var gridDataSource = new kendo.data.DataSource({
      transport: {
        read: { url: crudBaseUrl + "/customer/get", type: "GET", dataType: "json" },
        update: { url: crudBaseUrl + "/customer/update", type: "POST",  dataType: "json" },
        destroy: { url: crudBaseUrl + "/customer/destroy", type: "POST", dataType: "json" },
        create: {  url: crudBaseUrl + "/customer/store", type: "POST",  dataType: "json" },
    ...
    schema: {
      model: {
        ...
        fields: {
          ...
          customer_type_id: { field: "customer_type_id", type: "number" },
          gender: { type: "string" },  
          ...
          country_id: { field: "country_id", type: "number", nullable: true },   
          city_id: { field: "city_id", type: "number", nullable: true  },
          region: { type: "string", nullable: true }, 
          postal_code: { type: "string", nullable: true },
          address: { type: "string",  nullable: true },  
          detail: { type: "string",  nullable: true, }, 
          branch_id: { field: "branch_id", type: "number", defaultValue: 0 },
  ...
  $("#txtMultiSearch").keyup(function(e){   
    ...
    $("#grid").data("kendoGrid").dataSource.filter({
      ...
      filters: [
        ...
        { field  : "customer_type_id", operator: "contains", value  : q },
        { field  : "gender", operator: "contains",  value   : q },
        { field  : "date_of_birth",  operator: "contains", value  : q  },
        ...
        { field  : "branch_id", operator: "contains",  value   : q },
  ...
  function intiFormControl(){
    $("#customerTypes").kendoDropDownList({
      ...
      dataSource: {
        transport: {
          read: { url: crudBaseUrl+"/customer/type/list/filter" ,type: "GET", dataType: "json" }
        }
      }
    });
