  ...
  <div class="row-12">
    <div class="row-6">
      ...
      <div class="col-12">
        ...
        <input type="tel" class="k-textbox" name="phone" data-bind="value:phone" placeholder="Enter phone number"  required data-required-msg="The phone field is required" pattern="^[0-9\ \]{9,13}$" validationMessage="Phone number format is not valid" style="width: 100%;"/>
      </div>
